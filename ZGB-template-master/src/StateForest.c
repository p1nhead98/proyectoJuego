...
// UINT8 col_tiles_forest[] = {1, 2, 3, 4, 20, 21, 26, 27, 28, 29, 30, 31, 40, 41, 42, 43, 44, 45, 50, 52, 53, 54, 57, 58, 59, 60, 61, 62, 65, 83, 84, 85, 86, 0};
...
// extern const UINT16 bp_gameover[];
// extern const UINT16 s_gameover[];
...
// extern const UINT16 s_palette_1[];
...
// extern const struct MapInfo *ForestLevels[];
...
// void Start_StateForest()
// {
// 	UINT8 i;
// 	const struct MapInfo *ForestLevel = ForestLevels[current_level];
// 	gameOver = FALSE;
// 	SPRITES_8x16;
	/*
0: player
...
*/
	...
	// SpriteManagerLoad(29);
	// switch (current_level)
	// {

	// case 0:

		// scroll_target = SpriteManagerAdd(SpritePlayer, 32, 80);
		// SetPalette(SPRITES_PALETTE, 0, 8, s_palette_1, bank_StateForest);
		// SetPalette(BG_PALETTE, 0, 8, bp_forest1, bank_StateForest);
		// InitScroll(ForestLevel, col_tiles_forest, col_down_forest);
...
// 		SetPalette(SPRITES_PALETTE, 0, 8, s_gameover, bank_StateForest);
// 		SetPalette(BG_PALETTE, 0, 8, bp_gameover, bank_StateForest);
// 	}
// }